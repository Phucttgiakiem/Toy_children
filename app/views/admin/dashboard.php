...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="/Toy_children/public/assets/img/kaiadmin/favicon.ico"
      type="image/x-icon"
    />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <!-- Fonts and icons -->
    <script src="/Toy_children/public/assets/js/webfont.min.js"></script>
    <script>
      WebFont.load({
        ...
        custom: {
          ...
          urls: ["/Toy_children/public/assets/css/fonts.min.css"],
        },
        active: function () {
    ...
    <link rel="stylesheet" href="/Toy_children/public/assets/css/demo.css" />
  </head>
  <body>
    <div class="wrapper">
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="Toy_children/public/assets/img/flags/id.png"
                                      alt="indonesia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="Toy_children/public/assets/img/flags/us.png"
                                      alt="united states"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="Toy_children/public/assets/img/flags/au.png"
                                      alt="australia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="Toy_children/public/assets/img/flags/ru.png"
                                      alt="russia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="Toy_children/public/assets/img/flags/cn.png"
                                      alt="china"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="Toy_children/public/assets/img/flags/br.png"
                                      alt="brazil"
                                    />
                                  </div>
                                </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-list py-4">
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="Toy_children/public/assets/img/jm_denis.jpg"
                            alt="..."
                      ...
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="Toy_children/public/assets/img/talha.jpg"
                            alt="..."
                            class="avatar-img rounded-circle"
                          />
                        </div>
                      ...
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="Toy_children/public/assets/img/chadengle.jpg"
                            alt="..."
                            class="avatar-img rounded-circle"
                          />
                        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer d-flex justify-content-center">
                <button type="button" class="btn btn-secondary" id="close-notice" data-bs-dismiss="modal">Close</button>
